...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_product'])) {
    $centerId = $_POST['center_id']; // Updated to match the form's name attribute
    ...
    // Success message to display after adding a product
    $successMessage = "Product '$productName' added successfully to the center.";
}
